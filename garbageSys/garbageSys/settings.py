"""
Django settings for garbageSys project.
...
SECRET_KEY = '40=wg#=0e^^z3c3@1g*c*$2f2wmfhflj=f9h7d=5dv*%pi0e*q'
...
WSGI_APPLICATION = 'garbageSys.wsgi.application'
